 ...
 **/
public class BizStateRedisStrategy extends BaseStrategy<IChainDriver> implements IBizStateStrategy<IChainDriver> {
    public static final Logger logger = LoggerFactory.getLogger(BizStateRedisStrategy.class);
    //todo:采用redis进行
    //bizId->state
