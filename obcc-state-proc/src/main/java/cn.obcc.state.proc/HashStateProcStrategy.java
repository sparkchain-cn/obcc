 ...
 **/
public class HashStateProcStrategy extends BaseStrategy<IChainDriver> implements IHashStateStrategy<IChainDriver> {
    public static final Logger logger = LoggerFactory.getLogger(HashStateProcStrategy.class);
