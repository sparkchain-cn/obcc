 ...
 **/
public class NonceRedisStrategy extends BaseStrategy<IChainDriver> implements INonceStrategy<IChainDriver> {
    public static final Logger logger = LoggerFactory.getLogger(NonceRedisStrategy.class);
    ...
    public String setValueIntoRedis(String key, Long value, Long time) {
        throw new RuntimeException("um impl.");
    }
