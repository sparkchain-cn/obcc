...
//
////    public static void setBizState(IChainDriver driver, ChainPipe pipe, String hash, ETransferState status) throws Exception {
////        String recId = pipe.getRecordInfo().getId() + "";
////       BizState bizState = new BizState(pipe.getBizId(), hash, recId, status);
////       driver.getStateMonitor().setBizState(pipe.getBizId(), bizState);
////    }
////
//    public static void setHashState(IChainDriver driver, ChainPipe pipe, String hash, ETransferState status) throws Exception {
//        String recId = pipe.getRecordInfo().getId() + "";
//       BizState bizState = new BizState(pipe.getBizId(), hash, recId, status);
