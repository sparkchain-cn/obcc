...
//import cn.obcc.driver.utils.SpcMemoUtils;
...
//
//
//	public static TransactionInfo getTransaction(String hash, ReqConfig<Web3j> config) throws Exception {
//		try {
...
//				String gasFeeString = EthUtils.fromValueInMin(gasFee, decimal).toString();
...
//	}
//
//	public static TransactionInfo getTransaction(String hash, int decimal, ReqConfig<Web3j> config) throws Exception {
//		try {
//			Web3j chain3j = config.getClient();
//			Transaction tx;
//			try {
